...
class ExerciseAgent:
    def __init__(self, model: langchain.llms) -> None:
        ...
        self.alternative_temp = """Du bist ein Tutor für Mathe Schüler der 12. Klasse am Gymnasium in Deutschland. Sie werden dir eine Frage stellen,
        ...
        self.__prompt_template = PromptTemplate(
            ...
            template=self.alternative_temp)
    ...
    def run(self, aufgabe: str, loesung: str, frage: str) -> str:
        result: str = self.__chain.run({"aufgabe": aufgabe, "loesung": loesung,
                                        "frage": frage, "verlauf": self.verlauf})
        self._set_verlauf(frage, result)
        return result

    def _set_verlauf(self, frage: str, antwort: str) -> None:
        self.verlauf = ("Du hattest folgende Konversation bis jetzt" + "Frage des Schülers: " + frage +
